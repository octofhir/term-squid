...
async function fetchCodeSystems([search, page, fhirVersion]: [string, number, string]) {
  const params = new URLSearchParams()
  if (search) params.set('name', search)
  params.set('_count', PAGE_SIZE.toString())
  params.set('_offset', ((page - 1) * PAGE_SIZE).toString())

  const response = await fetch(`/${fhirVersion}/CodeSystem?${params}`)
  ...
  return (
    <div class={styles.container}>
      <header class={styles.header}>
        <div>
          <h1>CodeSystems</h1>
          <p>Browse and search FHIR CodeSystems</p>
        </div>
          ...
          <div class={styles.contentWrapper}>
            ...
            <For each={data()?.entry}>
              {(item: any) => {
                ...
                const concepts = () => item.resource.concept?.slice(0, 50) || []
                ...
                return (
                  <div class={styles.item}>
                    ...
                    <div class={styles.itemFooter}>
                      ...
                      <Show when={item.resource.content}>
